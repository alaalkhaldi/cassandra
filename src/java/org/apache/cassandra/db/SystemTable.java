...
public class SystemTable
{
    ...
    public static final String MetadataTags_CF = "metadata_tags";
    public static final String MetadataRegistry_CF = "metadata_registry";
    public static final String MetadataLog_CF = "metadata_log";
